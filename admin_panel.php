          ...
          <div class="col-lg-12 col-md-6 d-flex align-items-stretch mt-4 mt-lg-0">
            <div class="course-item">
              ...
              <form action="update.php" method="GET">
                <input type="" name="heading" class="form-control" value="<?php echo $result['heading']?>">
                <p></p>
                <input type="" name="question" class="form-control" value="<?php echo $result['question']?>">
                <input type="" style="" name="user_id" class="form-control" value="<?php echo $result['user_id']?>">
